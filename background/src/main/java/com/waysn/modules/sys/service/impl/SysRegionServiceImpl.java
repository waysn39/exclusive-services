...
import com.waysn.modules.sys.dao.SysRegionDao;
import com.waysn.modules.sys.dto.SysRegionDTO;
import com.waysn.modules.sys.dto.region.Region;
import com.waysn.modules.sys.dto.region.RegionCity;
import com.waysn.modules.sys.dto.region.RegionProvince;
import com.waysn.modules.sys.entity.SysRegionEntity;
import com.waysn.modules.sys.enums.RegionLeafEnum;
import com.waysn.modules.sys.enums.RegionLevelEnum;
...
public class SysRegionServiceImpl extends BaseServiceImpl<SysRegionDao, SysRegionEntity> implements SysRegionService {
    ...
    public void update(SysRegionDTO dto) {
        ...
        if (entity.getId().equals(entity.getPid())) {
            throw new ServicesException(ErrorCode.SUPERIOR_REGION_ERROR);
        }
