...
import com.waysn.modules.log.enums.LoginOperationEnum;
import com.waysn.modules.log.enums.LoginStatusEnum;
import com.waysn.modules.log.service.SysLogLoginService;
import com.waysn.modules.security.dto.LoginDTO;
...
import com.waysn.modules.sys.enums.UserStatusEnum;
...
public class LoginController {
    ...
    public Result login(HttpServletRequest request, @RequestBody LoginDTO login) {
        ...
        if (user == null) {
            ...
            throw new ServicesException(ErrorCode.ACCOUNT_PASSWORD_ERROR);
        }
        ...
        if (user.getStatus() == UserStatusEnum.DISABLE.value()) {
            ...
            throw new ServicesException(ErrorCode.ACCOUNT_DISABLE);
        }
